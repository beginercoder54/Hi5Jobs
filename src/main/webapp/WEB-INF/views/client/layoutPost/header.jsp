    ...
    <div class="main-container">
        <div class="sidebar">
            ...
            <div class="section">
                ...
                <div class="item"><a href="#" onclick="alert('Coming soon'); return false;"><img src="icon3.png"> Tổng quan</a></div>
                <div class="item"><a href="#" onclick="alert('Coming soon'); return false;"><img src="icon4.png"> Chiến dịch tuyển dụng</a></div>
                <div class="item"><a href="${pageContext.request.contextPath}/manage-cv"><img src="icon6.png"> Quản lý tuyển dụng</a></div>
