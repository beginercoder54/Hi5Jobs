...
<html>
    ...
    <body>
        ...
        <!-- Ô tìm kiếm -->
        <form action="${pageContext.request.contextPath}/search-job" method="get">
            ...
            <c:forEach var="user" items="${jobseekers}">
                <tr style="background-color: ${status.index % 2 == 0 ? '#fffbe6' : '#ffffff'};">
                    ...
                    <td>
                        ...
                        <!-- Button Xóa -->
                        <form action="${pageContext.request.contextPath}/delete-job?jobID=${user.jobID}" method="post" style="display:inline;" 
